...
policyTarget = T0
rules = Rule_Student_Read_Marks_Permit + Rule_Student_ReadModify_Marks_Deny
...
one sig Rule_Student_ReadModify_Marks_Deny extends Rule {}{
ruleTarget = Target_Student_ReadModify_Marks_Deny
ruleEffect = Deny
}

one sig Target_Student_ReadModify_Marks_Deny extends Target {}{
subjects = SStudent
resources = RMarks
actions = ARead + AModify
}
